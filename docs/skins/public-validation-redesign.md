...
- 蔡徐坤官方站点当前以 `Tour`、`Music`、`Videos` 和新专辑/视频入口为主，因此验证皮肤采用舞台、巡演、音乐制作和人物肖像语义，但不搬运官方照片、Logo、签名、歌词或官方物料。
- Square Enix 官方商品页明确 Tifa Lockhart 属于 `FINAL FANTASY VII REBIRTH`，并突出手套、靴子、可动姿态和角色设计归属；因此验证皮肤采用同人角色立绘、酒馆训练、拳套和木质空间语义，但不搬运官方角色图、Logo、截图或精确官方构图。
...
- 两套均改为 `redistributionAllowed=true`，用于公开非商用导入和应用流程验证；
...
- `dist/v1.1.1/Cai-Xukun-Stage-Check-1.0.1.codexskin`
  SHA-256：`5e28a6ca6db063ef0cf84926e5d62ee26ba1c91517e04151849217d22be3e7fe`
- `dist/v1.1.1/Tifa-Seventh-Heaven-Flow-1.0.1.codexskin`
  SHA-256：`dfdad3d11227342cb420b24463805847885e73b9032b15281e88533f9099af42`
